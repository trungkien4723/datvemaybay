                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" type="tel" pattern="^[0-9]{9,11}$"class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone')??$passenger->phone }}" autocomplete="phone">
